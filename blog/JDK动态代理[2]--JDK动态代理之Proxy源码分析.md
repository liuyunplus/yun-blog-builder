...
date: 2018-01-05
categories: Java基础
cover: 'https://raw.githubusercontent.com/liuyunplus/yun-blog-builder/main/cover/cover10.jpg'
abstract: '在上一篇里为大家简单介绍了什么是代理模式？为什么要使用代理模式？并用例子演示了一下静态代理和动态代理的实现，分析了静态代理和动态代理各自的优缺点。在这一篇中笔者打算深入源码为大家'
---
